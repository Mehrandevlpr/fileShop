...
<header class="header-v4">
    ...
    <div class="modal-search-header flex-c-m trans-04 js-hide-modal-search">
        <div class="container-search-header">
            ...
            <form class="wrap-search-header flex-w p-l-15" action="{{ route('frontend.products.all') }}">
        ...
        <div class="header-cart-content flex-w js-pscroll">
            <ul class="header-cart-wrapitem w-full">
                @if(!is_null(Cookie::get('basket')) && !empty(Cookie::get('basket')))
                    @foreach(json_decode(Cookie::get('basket'),true) as $key => $cookie )
                        <li class="header-cart-item flex-w flex-t m-b-12">
                            <a href="{{ route('frontend.baskets.remove',$key) }}">
                                <div class="header-cart-item-img">
                                    <img src="/{{ $cookie['demo_url'] }}" alt="IMG">
                                </div>
                            </a>
                            <div class="header-cart-item-txt p-t-8">
                                <a href="{{ route('frontend.products.single',$key) }}" class="header-cart-item-name m-b-18 hov-cl1 trans-04">
                                    {{ $cookie['title'] }}  
                                </a>

                                <span class="header-cart-item-info">
                                {{ $cookie['price'] }} هزار تومان
                                </span>
                            </div>
                        </li>
                    @endforeach
            ...
            <div class="w-full">
                ...
                <div class="header-cart-buttons flex-w w-full">
                    <a href="{{ route('frontend.baskets.checkout') }}" class="flex-c-m stext-101 cl0 size-107 w-100 bg3 bor2 hov-btn3 p-lr-15 trans-04 m-l-8 m-b-10">
