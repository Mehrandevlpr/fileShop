        ...
        <div class="row mb-2 mt-4">
          <div class="col-12">
            <h1 class="m-0 text-dark">
                ...
                محصولات / بروزرسانی - <small>{{ $product->title }}</small>
                              ...
                              <div class="row">
                                  <div class="col-md-4">
                                      <div class="form-group">
                                          ...
                                          <img width="100px" height="100px" src="/{{ $product->thumbnail_url }}" alt="">
                                      </div>
                                  </div>
                                  <div class="col-md-4">
                                      <div class="form-group">
                                          ...
                                          <img width="100px" height="100px" src="/{{ $product->demo_url }}" alt="">
                                      </div>
                                  </div>
                                  <div class="col-md-4">
                                      <div class="form-group">
                                          ...
                                          <button href="/{{ $product->source_url }}" class="btn btn-primary text-white mt-2">فایل اصلی</button>
                                      </div>
                                  </div>
